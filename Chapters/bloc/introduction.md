...
Make your cross blink by defining this methods as follows:
...
The animation will start immediatly once added to your element.
...
Here is full source for the cross. Please note that we don't need to subclass
*BlElement* to create a custom element. You mainly need to customize your element
properties to fit your need
...
If it is rejected, it'll be move to a specified location.
...
The default behaviour is for it to do nothing, that is, to sit below the target,
